...
public class ClienteGUI extends javax.swing.JFrame {
      ...
      public void preencherTabela() throws Exception{
       ...
       public void preencherTabelaPesquisa(String desc) throws Exception{
        ...
        modelo.setNumRows(0);
            ...
            for(Cliente cliente: clienteDAO.pesquisarCliente(desc)){
                modelo.addRow(new Object[]{
                    cliente.getNome(),
                    cliente.getCpf(),
                    cliente.getEmail(),
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(20, 260, 750, 120);

        jLabel3.setText("Pequisar:");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(20, 100, 60, 16);
        ...
        jTPesquisar.setBounds(20, 120, 100, 22);
        ...
        jButton1.setBounds(140, 120, 100, 22);
...
//      jTFDataDeNacimento.setText(jTCliente.getValueAt(jTCliente.getSelectedRow(),5).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
            preencherTabelaPesquisa(jTPesquisar.getText().toString());
        } catch (Exception e) {
            System.out.println(e);
        }
